...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (params.has("event") && params.get("event") === validEvent) {
    ...
    // ======================== DENNA DEL FUNGERAR EJ ÄN ================================ NEEDS FIX!
    ...
    if (validPages.includes(currentPage)) {
      ...
      if (storedEvent === validEvent) {
        ...
        function changeShoppingCardTextUnderTitle(currentText, newText) {
          var paragraphs = document.querySelectorAll(
            ".cwShopPageShoppingChart .cwCheckoutItems p"
          );
          paragraphs.forEach(function (paragraph) {
            if (paragraph.innerText.trim() === currentText) {
              paragraph.innerText = newText;
        ...
        changeShoppingCardTextUnderTitle(
          "Markera vilka bokningar du vill betala på en och samma inbetalning. Du kan senare välja att betala de bokningar du inte inkluderat denna gång.",
          "Markera vilka bokningar du vill betala på en och samma inbetalning. Du kan senare välja att betala de beställningar du inte inkluderat denna gång."
        );
